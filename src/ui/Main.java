...
public class Main {
	...
	public static void main(String[] args) {
		...
		Technician e1 = new Technician("Bardia", "Fathi", "Male", "HOD", 3, 25000.00, 1500.00);
		Technician e2 = new Technician("Maria", "LastName", "Female", "HOS", 2, 22000.00, 1000.00);
		Sales e3 = new Sales("Mothana", "Aboush", "Male", "HOD", 3, 35000.00, 10000.00);
//		Secretary e4 = new Secretary("Mera", "Alxander", "Female", "REP", 1, 18000.00, 1000.00);
