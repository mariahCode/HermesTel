...
public class Secretary extends Employee {
	...
	static public ArrayList<Secretary> secretaryList = new ArrayList<>();

	// Constructor. 
	public Secretary(String firstName, String lastName, String gender, String title, String grade, double salary) {
		
		super("SEC_", firstName, lastName, gender, title, grade, salary);
